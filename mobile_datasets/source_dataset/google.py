...
class GoogleDataset(InputDataset):
    def __init__(self, input_data_path, tmp_path, force):
        ...
        # self.params["IsOccluded"] = "0"
        # self.params["IsTruncated"] = "0"
        # self.params["IsInside"] = "0"
    ...
    def create_ann_dict(self,):
        ...
        ann_dict: (dict)
            ...
            An image is stored in ann_dict iff it respects params (IsOccluded, IsTruncated etc) (Those are also hyperparameters TBD)
        """
